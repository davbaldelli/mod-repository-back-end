module github.com/davide/ModRepository
...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.61.1024 // indirect
	...
	github.com/foomo/simplecert v1.8.3 // indirect
	...
	gopkg.in/ns1/ns1-go.v2 v2.5.0 // indirect
